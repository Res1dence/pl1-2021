...
------
  ...
  object Hw02Task1 {
    ...
    def evalCountVisitor( e:Exp): Int =
      e match{
        case Num(n) => 1
        case Add(l,r) => evalCountVisitor(l) + evalCountVisitor(r)
      }

    def evalPrintVisitor( e:Exp ): String =
      e match{
        case Num(n) => n.toString
        case Add(l,r) => evalPrintVisitor(l) + evalPrintVisitor(r)
      }
...
------
    ...
    object Hw02Task2 {
      ...
      def eval(e: Exp) : Boolean = e match {
        ...
        case Not(x) => eval(Nand(x,True()))
        case And(l,r) => eval(Not(Nand(l,r)))
        case Or(l,r) => eval(Nand(Not(l), Not(r)))
...
"let" and "let*" binding constructs in Scheme and Racket.
      ...
      def eval(e: Exp) : Int = e match {
        ...
        case Let(defs,body) => eval(subst( e, "let",0))
